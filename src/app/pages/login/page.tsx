...
export default function Login() {
  ...
  /* Login Validation */
  useEffect(() => {
    if (user.username.length > 0 && user.password.length > 0 && user.username.length > 0) {
  ...
  return (
    <div className="bg-blue-500 flex flex-col items-center justify-center min-h-screen py-2 gap-2">
      <h1 className="text-3xl">{loading ? "Login" : "Conectando..."}</h1>
      <hr />
      ...
      <button onClick={onLogin} className="p-2 rounded bg-green-400">
